---
description: How to add, remove, and edit details of pages on the site
---
...
The pages and sub-pages on the website [come from the folder and file structure of your repo.](repo-structure.md)
